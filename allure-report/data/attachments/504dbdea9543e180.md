...
Call log:
  - waiting for locator('a.nav-link:has-text("Home")')
    - locator resolved to <a class="nav-link" href="index.html">…</a>
  - attempting click action
    - waiting for element to be visible, enabled and stable

    at HomePage.addItemToCart (C:\Users\Amitu\OneDrive\Desktop\Playwright_Framework\OnePassMobileAuto\pages\HomePage.js:44:21)
...
- link:
  - /url: "#myCarousel-2"
- heading "Sony xperia z5" [level=2]
- separator
- heading "$320 *includes tax" [level=3]
- separator
- list:
  - listitem
